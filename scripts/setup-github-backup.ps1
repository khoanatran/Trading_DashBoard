...
Write-Host 'On other computers: npm run launch (pulls latest data automatically).' -ForegroundColor Green
Write-Host 'Manual sync: npm run github:pull | github:backup | github:sync'
